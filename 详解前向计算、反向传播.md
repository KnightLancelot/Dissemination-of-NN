...
高学历的人、更高门槛的工作、更高收入的工作往往更容易被AI所取代。不过文章同时也指出，那些需要科研能力和批判思维能力的工作暴露率（高风险率）较低。
专家和模型各选了一批受影响最严重的职业，其中包括：数学家、报税员、量化金融分析师、作家、网络和数字界面设计师，还包括新闻记者、法务、行政、通讯员、区块链工程师、翻译、公关专家、调研员等职业。
